<template>
  <div class="q-pa-md q-gutter-sm shadow-4 row q-mb-md">
    <div class="col-2 ">
      <q-img class="shadow-24 rounded-borders col profile-pic"
        :src="summary.url"
        spinner-color="white"
      />
    ...
    <div class="col-9 ">
        ...
        <!-- <p class="text-italic text-right text-weight-medium">
            {{text_3}}
        </p> -->
        <div>
